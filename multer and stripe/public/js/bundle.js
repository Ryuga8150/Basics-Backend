...
const login = async (email, password) => {
  ...
  try {
    ...
    if (res.data.status === "success") {
      ...
      (0,_alert__WEBPACK_IMPORTED_MODULE_0__.showAlert)("success", "Logged in Successfully");
      window.setTimeout(() => {
        location.assign("/");
      }, 1500);
    }
...
const logout = async () => {
  try {
    ...
    if (res.data.status === "success") {
      ...
      (0,_alert__WEBPACK_IMPORTED_MODULE_0__.showAlert)("success", "Logged Out Successfully");
